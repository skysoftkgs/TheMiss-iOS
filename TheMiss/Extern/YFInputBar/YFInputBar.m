...
{
    if (!_textField) {
        _textField = [[UITextField alloc]initWithFrame:CGRectMake(10, 10, 260, 30)];
...
-(UIButton *)sendBtn
{
    if (!_sendBtn) {
        ...
        [_sendBtn setTitle:@"Comment" forState:UIControlStateNormal];
//        [_sendBtn setBackgroundColor:[UIColor whiteColor]];
        [_sendBtn setBackgroundImage:[UIImage imageNamed:@"comment_send_deactive_btn"] forState:UIControlStateNormal];
        [_sendBtn setTitleColor:[UIColor whiteColor] forState:UIControlStateNormal];
        [_sendBtn setFrame:CGRectMake(280, 10, 30, 30)];
...
- (BOOL) textField:(UITextField *)textField shouldChangeCharactersInRange:(NSRange)range replacementString:(NSString *)string{
    ...
    if (str.length>0) {
        [_sendBtn setBackgroundImage:[UIImage imageNamed:@"comment_send_active_btn"] forState:UIControlStateNormal];
    }else{
        [_sendBtn setBackgroundImage:[UIImage imageNamed:@"comment_send_deactive_btn"] forState:UIControlStateNormal];
    }
